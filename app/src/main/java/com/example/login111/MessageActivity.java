...
import com.example.login111.Adapter.MessageAdapter;
...
public class MessageActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String str = intent.getStringExtra("etext");
        text_send.setText(str);
    ...
    public void Mic(View view){
        ...
        //Button blisten = findViewById(R.id.listen);
    ...
    public void GifSelect(View view)
    {
        Intent intent = new Intent(getApplicationContext(),GifSelector.class);
...
//        intent = getIntent();
//        String etext = "";
//        etext = intent.getStringExtra("etext");
////        text_send.setText(etext);
//    }
